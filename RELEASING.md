...
| --- | --- | --- |
| contract | @alien-id/miniapps-contract | 1.5.0-alpha |
| bridge | @alien-id/miniapps-bridge | 1.4.1-alpha |
| react | @alien-id/miniapps-react | 1.6.0-alpha |
| auth-client | @alien-id/miniapps-auth-client | 1.5.0-alpha.2 |
| solana-provider | @alien-id/miniapps-solana-provider | 1.4.1-alpha |
...
Dependents that had no code changes get a **patch** bump (the dependency version
changed, which is a publishable change). Only the root package you intended to
release gets the bump type you chose (minor, major, etc.).
...
If `bun install` shows "no changes" but versions are wrong,
